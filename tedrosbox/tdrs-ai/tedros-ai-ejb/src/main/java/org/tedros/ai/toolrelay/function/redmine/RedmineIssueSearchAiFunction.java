...
/**
 * Versao de backend da {@code RedmineIssueSearchAiFunction} do FE
 ...
 */
@ApplicationScoped
public class RedmineIssueSearchAiFunction implements TServerAiFunction {

	private static final TLoggerUtil LOGGER = TLoggerUtil.create(RedmineIssueSearchAiFunction.class);
	...
	public Class<?> getModel() {
		return RedmineIssueFilter.class;
	}

	@Override
	public Object execute(Object arg, TAiToolContext ctx) {
		RedmineIssueFilter v = (RedmineIssueFilter) arg;
		try {
			...
			LOGGER.error("Error filtering Redmine issues", e);
			return Map.of(
					STATUS, ERROR,
