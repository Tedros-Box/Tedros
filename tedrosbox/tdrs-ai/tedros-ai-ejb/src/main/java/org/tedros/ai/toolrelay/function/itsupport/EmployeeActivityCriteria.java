...
/**
 * Copia de {@code org.tedros.it.tools.employeeactivity.ai.function.EmployeeActivityCriteria}
 * (app-itsupport-tools-fx) — mesmos campos/tipos para schema identico.
 */
@Data
@Builder
@NoArgsConstructor
