...
/**
 * Versao de backend da {@code GetGitLabRepositoryBranchFunction} do FE
 ...
 */
@ApplicationScoped
public class GetGitLabRepositoryBranchFunction implements TServerAiFunction {

	private static final TLoggerUtil LOGGER = TLoggerUtil.create(GetGitLabRepositoryBranchFunction.class);
	...
	public Class<?> getModel() {
		return TGitLabBranch.class;
	}

	@Override
	public Object execute(Object arg, TAiToolContext ctx) {
		TGitLabBranch v = (TGitLabBranch) arg;
		try {
