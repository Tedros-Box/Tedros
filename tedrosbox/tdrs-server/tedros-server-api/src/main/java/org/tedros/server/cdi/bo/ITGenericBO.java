...
/**
 * Generic Business Object interface for entities that implement {@link ITEntity}.
 * Provides common CRUD and search operations, with optional filtering by user ID.
 *
...
public interface ITGenericBO<E extends ITEntity> {
    ...
    /**
     * Returns the Entity Access Object (EAO) used by this BO.
     *
     * @return the generic EAO for the entity type
     */
    ITGenericEAO<E> getEao();
     ...
     *
     * @param entity the class of the entity to list
